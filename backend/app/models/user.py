...
class User(Base):
    ...
    # Nullable pour comptes OAuth (pas de mot de passe local)
    hashed_password = Column(String, nullable=True)
    full_name = Column(String, nullable=True)
    ...
    # Quota stockage : 30 Go par défaut
    storage_used = Column(BigInteger, default=0)
    storage_quota = Column(BigInteger, default=32212254720)
    
    # OAuth : provider (google/microsoft) + ID unique provider
    ...
    # Relations cascade : suppression user = suppression fichiers/dossiers
